...
void sx127x_set_state(sx127x_t *dev, uint8_t state)
{
    ...
    switch (state) {
    case SX127X_RF_IDLE:
        sx127x_log(SX127X_DEBUG, "[DEBUG] Change state: IDLE\n");
        break;
    case SX127X_RF_RX_RUNNING:
        sx127x_log(SX127X_DEBUG, "[DEBUG] Change state: RX\n");
        break;
    case SX127X_RF_TX_RUNNING:
        sx127x_log(SX127X_DEBUG, "[DEBUG] Change state: TX\n");
        break;
    default:
        sx127x_log(SX127X_DEBUG, "[DEBUG] Change state: UNKNOWN\n");
        break;
    }
#endif
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set syncword: %d\n", syncword);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set channel: %d\n", channel);
        ...
        case SX127X_MODEM_LORA:
        {
            ...
            switch (dev->settings.lora.bandwidth) {
                ...
                case SX127X_BW_500_KHZ:
                    ...
                    break;
                default:
                    sx127x_log(SX127X_DEBUG, "Invalid bandwith: %d\n", dev->settings.lora.bandwidth);
                    break;
            }
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set sleep\n");
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set standby\n");
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set RX\n");
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set max payload len: %d\n", maxlen);
...
void sx127x_set_op_mode(const sx127x_t *dev, uint8_t op_mode)
{
    ...
    case SX127X_RF_OPMODE_SLEEP:
        sx127x_log(SX127X_DEBUG, "[DEBUG] Set op mode: SLEEP\n");
        break;
    case SX127X_RF_OPMODE_STANDBY:
        sx127x_log(SX127X_DEBUG, "[DEBUG] Set op mode: STANDBY\n");
        break;
    case SX127X_RF_OPMODE_RECEIVER:
        sx127x_log(SX127X_DEBUG, "[DEBUG] Set op mode: RECEIVER\n");
        break;
    case SX127X_RF_OPMODE_TRANSMITTER:
        sx127x_log(SX127X_DEBUG, "[DEBUG] Set op mode: TRANSMITTER\n");
        break;
    default:
        sx127x_log(SX127X_DEBUG, "[DEBUG] Set op mode: UNKNOWN\n");
        break;
    }
#endif
...
inline void _update_bandwidth(const sx127x_t *dev)
{
    ...
    case SX127X_BW_500_KHZ:
        ...
        break;
    default:
        sx127x_log(SX127X_DEBUG, "Unsupported bandwidth, %d", dev->settings.lora.bandwidth);
        break;
    }
#else /* MODULE_SX1276 */
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set bandwidth: %d\n", bandwidth);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set spreading factor: %d\n", datarate);
    ...
    if (datarate == SX127X_SF6 &&
        ...
        sx127x_log(SX127X_DEBUG, "Spreading Factor 6 can only be used when explicit header "
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set coding rate: %d\n", coderate);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set RX single: %d\n", single);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set CRC: %d\n", crc);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set Hop period: %d\n", hop_period);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set fixed header length: %d\n", fixed_len);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set payload len: %d\n", len);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set power: %d\n", power);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set preamble length: %d\n", preamble);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set RX timeout: %d\n", timeout);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set TX timeout: %d\n", timeout);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set symbol timeout: %d\n", timeout);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set IQ invert: %d\n", iq_invert);
...
{
    sx127x_log(SX127X_DEBUG, "[DEBUG] Set freq hop: %d\n", freq_hop_on);
